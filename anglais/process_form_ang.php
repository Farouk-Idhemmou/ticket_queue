...
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(0, 10, utf8_decode('Ticket number       : ' . $newTicketNumber), 0, 1, 'L');
$pdf->Cell(0, 10, utf8_decode('Your service         : ' . $serviceChoisi), 0, 1, 'L');
$pdf->Ln(10);

$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(0, 10, 'Redal Center    ', 0, 0, 'L'); // Align to the left
$pdf->SetFont('Arial', '', 8);
